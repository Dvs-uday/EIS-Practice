...
public class BatchJobController {
    ...
    @GetMapping("/getJob")
    public ResponseEntity<List<ResponseModel>> getBatchJobData(@RequestParam String jobName, @RequestParam String date) {
        List<ResponseModel> data = executionService.getBatchByDate(jobName,date);
        return ResponseEntity.ok(data);
    ...
    @PostMapping("/rerun-job")
    public ResponseEntity<String> getJobDetails(@RequestParam String jobInstanceId) {

        String jobDetails = "Running" + jobInstanceId;
